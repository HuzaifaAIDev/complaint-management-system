...
//   useEffect(() => {
//     apiGet<{ enabled: boolean }>("/auth/google/config").then((res) => setEnabled(res.enabled)).catch(() => setEnabled(false));
//   }, []);

//   if (!enabled) return null;

//   const handleClick = () => {
//     // Full browser navigation, not a fetch - this has to leave the SPA
//     // for Google's consent screen and come back via a real redirect.
...
function GoogleGlyph() {
  return (
    ...
    >
      ...
      <path
        fill="#FBBC05"
        d="M3.95 10.7A5.4 5.4 0 0 1 3.67 9c0-.59.1-1.17.28-1.7V4.97H.94A9 9 0 0 0 0 9c0 1.45.35 2.83.94 4.03z"
      />
      <path
        fill="#EA4335"
        d="M9 3.58c1.32 0 2.5.45 3.44 1.35l2.58-2.58C13.46.89 11.43 0 9 0A9 9 0 0 0 .94 4.97L3.95 7.3C4.66 5.17 6.65 3.58 9 3.58z"
      />
    </svg>
  );
}
...
export default function GoogleSignInButton({
  ...
  const handleClick = (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    // Prevent any navigation, API request, or error.
